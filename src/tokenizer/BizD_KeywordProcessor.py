...
class BizD_KeywordProcessor():
    def extract_keywords(self, sentence, span_info=False, max_cost=0, debug=False):
        ...
        while idx < sentence_len:
            ...
            if char not in self.non_word_boundaries:
                ...
                if self._keyword in current_dict or char in current_dict:
                    ...
                    if char in current_dict:
                        ...
                        while idy < sentence_len:
                            ...
                            if debug: print("if while:", inner_char)
                            ...
                            if inner_char in current_dict_continued:
                                ...
                                if not current_dict_continued:
                                    if debug: print("break1")
                                    break
                            else:
                                if debug: print("break2", sentence[idy])
                                break
                            idy += 1
                        else:
                            ...
                            if self._keyword in current_dict_continued:
                                ...
                                sequence_end_pos = idy
                                is_longer_seq_found = True
                        if debug: print(is_longer_seq_found)
                        if is_longer_seq_found:
                            idx = sequence_end_pos - 1
                        else:
                            if debug: print("Continue!!", inner_char, sentence[idx])
                    #                             idx = sequence_end_pos
                    #                         print("TEST: ",sentence[idx])
                    current_dict = self.keyword_trie_dict
                ...
                if debug: print('elif1:', char)
                # we can continue from this char
                current_dict = current_dict[char]
            elif curr_cost > 0:
                if debug: print('elif2:', char)
                ...
                while idy < sentence_len:
                    char = sentence[idy]
                    if debug: print("else while:", char)
                    if char not in self.non_word_boundaries:
                        break
                    idy += 1
                idx = idy
